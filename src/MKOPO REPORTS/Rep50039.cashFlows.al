    ...
    dataset
    {
        dataitem("Company Information"; "Company Information")
        {
            ...
            begin
                ...
                // G/L movements use the selected period; opening balances are excluded.
                ...
                if (LStartDate < DMY2DATE(1, 1, 2024)) then
                    ...
                    repeat
                        ...
                        GLAccount.SetFilter("Date Filter", '%1..%2', LStartDate, LEndDate);
                        GLAccount.CalcFields("Net Change");
                ...
                if ((StartDate > DMY2DATE(31, 12, 2023)) and (EndDate < DMY2Date(1, 1, 2025))) then
                    ...
                    repeat
                        ...
                        GLAccount.SetFilter("Date Filter", '..%1', StartDate - 1);
                    ...
                    //GLEntry.SetFilter(GLEntry."Posting Date", '..%1', StartDate - 1);
                ...
                if (LStartDate < DMY2DATE(1, 1, 2024)) then
                    ...
                    if ((LStartDate < DMY2Date(1, 1, 2025)) and (LstartDate > DMY2Date(31, 12, 2023))) then
                        ...
                        repeat
                            ...
                            GLAccount.SetFilter("Date Filter", '..%1', LStartDate - 1);
                            GLAccount.CalcFields("Balance at Date");
                            LCashatbank += GLAccount."Balance at Date";
                        // GLEntry.Reset;
                        // GLEntry.SetRange(GLEntry."G/L Account No.", GLAccount."No.");
                        // GLEntry.SetFilter(GLEntry."Posting Date", '..%1', LStartDate - 1);
