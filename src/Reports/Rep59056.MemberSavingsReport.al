...
//             //RequestFilterFields = "No.", "Employer Code", "Account Category";
//             column(No_; "No.")
//             {
//             }
...
//             column(TransactionTypeFilter; TransactionTypeFilter) { }
...
//                 if TransactionTypeFilter <> TransactionTypeFilter::" " then
//                     CustLedgerEntries.SetRange("Transaction Type", TransactionTypeFilter);
...
//                         if CustLedgerEntries."Document No." = 'OBDEPOSITS' then begin
...
//                 }
//                 field(TransactionTypeFilter; TransactionTypeFilter)
//                 {
//                     ApplicationArea = All;
...
//             StartDate := DMY2Date(31, 12, 2024); //OPEN BALANCE DATE
...
//         TransactionTypeFilter: Enum TransactionTypesEnum;


//     // local procedure CalculateMemberTotals()
//     // begin
...
report 59056 "Member Savings Report"
{
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            column(TransactionTypeText; TransactionTypeText) { }
            ...
            begin
                ...
                if (OpeningBalance = 0) and (TotalCredits = 0) and (TotalDebits = 0) then
                    CurrReport.Skip();
    ...
    begin
        ...
        if StartDate <> 0D then
            ...
            DateFilterText := '..' + Format(EndDate);

        if TransactionTypeOption <> TransactionTypeOption::" " then
            TransactionTypeText := Format(TransactionTypeOption)
        else
            TransactionTypeText := 'Member Savings';
    end;
