report 59079 "Member Loan Books Details"
{
    ApplicationArea = All;
    Caption = 'Member Loan Books - Repayment Details';
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = './Layouts/MemberLoanBooksDetails.rdlc';
    dataset
    {
        dataitem(LoansRegister; "Loans Register")
        {
            ...
            // Keep the requested export names; values come from the loan record.
            column(MemberNo; LoansRegister."Client Code") { }
            column(ProductCode; LoansRegister."Loan Product Type") { }
            column(MonthylyPayBackAmount; LoansRegister.Repayment) { }
            // Interest is stored as an annual percentage (e.g. 12 means 12%).
            column(LoanInterestAnnaulaPercentageRate; LoansRegister.Interest) { }
